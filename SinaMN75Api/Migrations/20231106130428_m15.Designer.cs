                    ...
                    b.OwnsOne("Utilities_aspnet.Entities.OrderJsonDetail", "JsonDetail", b1 =>
                        {
                            ...
                            b1.OwnsMany("Utilities_aspnet.Entities.ReserveChairDto", "ReserveChairs", b2 =>
                                {
                                    b2.Property<Guid>("OrderJsonDetailOrderEntityId")
                                        .HasColumnType("uniqueidentifier");
                    ...
                    b.OwnsOne("Utilities_aspnet.Entities.ProductJsonDetail", "JsonDetail", b1 =>
                        {
                            ...
                            b1.OwnsOne("Utilities_aspnet.Entities.ReservationSaloon", "ReservationSaloon", b2 =>
                                {
                                    b2.Property<Guid>("ProductJsonDetailProductEntityId")
                                        .HasColumnType("uniqueidentifier");
                                    ...
                                    b2.OwnsMany("Utilities_aspnet.Entities.ReservationChairSection", "ReservationChairSections", b3 =>
                                        {
                                            b3.Property<Guid>("ReservationSaloonProductJsonDetailProductEntityId")
                                                .HasColumnType("uniqueidentifier");
                                            ...
                                            b3.HasKey("ReservationSaloonProductJsonDetailProductEntityId", "Id");

                                            b3.ToTable("Products");

                                            b3.WithOwner()
                                                .HasForeignKey("ReservationSaloonProductJsonDetailProductEntityId");

                                            b3.OwnsMany("Utilities_aspnet.Entities.ReservationChair", "ReservationColumns", b4 =>
                                                {
                                                    b4.Property<Guid>("ReservationChairSectionReservationSaloonProductJsonDetailProductEntityId")
                                                        .HasColumnType("uniqueidentifier");

                                                    b4.Property<int>("ReservationChairSectionId")
                                                        .HasColumnType("int");
                                                    ...
                                                    b4.Property<string>("ChairId")
                                                        .IsRequired()
                                                        .HasColumnType("nvarchar(max)");

                                                    b4.Property<long?>("Price")
                                                        .HasColumnType("bigint");

                                                    b4.Property<string>("ReservedByUserId")
                                                        .HasColumnType("nvarchar(max)");

                                                    b4.Property<string>("ReservedByUserName")
                                                        .HasColumnType("nvarchar(max)");

                                                    b4.Property<int?>("Tag")
                                                        .HasColumnType("int");

                                                    b4.HasKey("ReservationChairSectionReservationSaloonProductJsonDetailProductEntityId", "ReservationChairSectionId", "Id");

                                                    b4.ToTable("Products");

                                                    b4.WithOwner()
                                                        .HasForeignKey("ReservationChairSectionReservationSaloonProductJsonDetailProductEntityId", "ReservationChairSectionId");
                                                });

                                            b3.OwnsMany("Utilities_aspnet.Entities.ReservationChair", "ReservationRows", b4 =>
                                                {
                                                    b4.Property<Guid>("ReservationChairSectionReservationSaloonProductJsonDetailProductEntityId")
                                                        .HasColumnType("uniqueidentifier");
                                            ...
                                            b3.Navigation("ReservationColumns");

                                            b3.Navigation("ReservationRows");
                                        });

                                    b2.Navigation("ReservationChairSections");
                                });
                            ...
                            b1.Navigation("ReservationSaloon");
