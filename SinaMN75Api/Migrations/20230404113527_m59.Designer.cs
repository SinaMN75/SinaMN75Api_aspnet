...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("BookmarkEntityBookmarkFolderEntity", b =>
                {
                    b.Property<Guid>("BookmarkFoldersId")
                        .HasColumnType("uniqueidentifier");

                    b.Property<Guid>("BookmarksId")
                        .HasColumnType("uniqueidentifier");

                    b.HasKey("BookmarkFoldersId", "BookmarksId");
            ...
            modelBuilder.Entity("Utilities_aspnet.Entities.MediaEntity", b =>
                {
                    ...
                    b.Property<Guid?>("BookmarkFolderEntityId")
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.HasIndex("BookmarkFolderEntityId");
            ...
            modelBuilder.Entity("BookmarkEntityBookmarkFolderEntity", b =>
                {
                    b.HasOne("Utilities_aspnet.Entities.BookmarkFolderEntity", null)
                        .WithMany()
                        .HasForeignKey("BookmarkFoldersId")
            ...
            modelBuilder.Entity("Utilities_aspnet.Entities.GroupChatMessageEntity", b =>
                {
                    b.HasOne("Utilities_aspnet.Entities.UserEntity", "ForwardedFrom")
                        .WithMany()
            ...
            modelBuilder.Entity("Utilities_aspnet.Entities.MediaEntity", b =>
                {
                    b.HasOne("Utilities_aspnet.Entities.BookmarkFolderEntity", null)
                        .WithMany("Media")
                        .HasForeignKey("BookmarkFolderEntityId")
                        .OnDelete(DeleteBehavior.ClientCascade);
